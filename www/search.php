...
define('IN_ECS', true);
/* 代码添加_START  By   www.6gyhdnet.com */
...
else
{
   ...
   /* fulltext_search_add_END_www.6gyhdnet.com */
    ...
    $count = $db->getOne($sql);
	/* 代码添加_START   By  www.gyhdnet.com  */	
    if ($page == 1 && $Recordkw && $count && !$category) Recordkeyword($Recordkw, $count, 'ecshop');  // 代码修改  By   www.gyhdnet.com
	if($count==0)
	{
