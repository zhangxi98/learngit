...
FCKConfig.Plugins.Add('swfupload','zh-cn'); //代码增加 by	 www.gyhdnet.com
...
FCKConfig.ToolbarSets["Default"] = [
	['Source','DocProps','-','savehttpfiles','Save','NewPage','Preview','-','Templates'],
...
FCKConfig.ToolbarSets["Normal"] = [
  ...
  ['FitWindow','-','Source','savehttpfiles'],
  '/',
  ['FontFormat','FontSize'],
...
] ;//上面一行最后增加了一个 swfupload，By www.gyhdnet.com 
