package com.jsyh.onlineshopping.umeng.share;
...
public class Share {
    ...
    public Share(Activity context,String title,String content,String url,String image){
    ...
    private void setShareContent() {
        ...
        QZoneSsoHandler qZoneSsoHandler = new QZoneSsoHandler(context,
                ConfigValue.QQAPP_ID, ConfigValue.QQAPP_KEY);
        qZoneSsoHandler.addToSocialSDK();
