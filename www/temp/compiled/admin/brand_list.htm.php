...
<form method="post" action="brand.php?act=batch_drop" name="listForm" onsubmit="return confirm('<?php echo $this->_var['lang']['batch_drop_confirm']; ?>')">
<!-- start brand list -->
...
<?php endif; ?>
  ...
  <table cellpadding="3" cellspacing="1">
    <tr>
      <th><input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox" /><?php echo $this->_var['lang']['record_id']; ?></th>
...
?>
    <tr>
      <td><input value="<?php echo $this->_var['brand']['brand_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['brand']['brand_id']; ?></td>
      <td class="first-cell">
