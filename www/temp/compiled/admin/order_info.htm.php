...
<table width="100%" cellpadding="3" cellspacing="1">
 ...
 <!--增值税发票_删除_START_www.gyhdnet.com-->
  ...
  <!--包装、贺卡、贺卡祝福语_删除_START_www.gyhdnet.com-->
<!--   <tr>
  ...
  <!--包装、贺卡、贺卡祝福语_删除_END_www.gyhdnet.com-->
  <tr>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td scope="col" width="30%"><div align="center"><strong><?php echo $this->_var['lang']['goods_name_brand']; ?></strong></div></td>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
	...
	<!-- 一键发货begin 修改 by www.gyhdnet.com  -->  
