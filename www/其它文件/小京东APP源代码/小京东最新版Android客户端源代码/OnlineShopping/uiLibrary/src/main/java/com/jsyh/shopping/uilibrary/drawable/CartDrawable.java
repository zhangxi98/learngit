...
public class CartDrawable extends Drawable implements Animatable {
    ...
    public CartDrawable(Context context,int flag) {
        if (flag == 0)
            icon_cart = context.getResources().getDrawable(R.mipmap.shopping_cart);
        else
            icon_cart = context.getResources().getDrawable(R.mipmap.shopping_car_press);
        mPaint = new Paint();
