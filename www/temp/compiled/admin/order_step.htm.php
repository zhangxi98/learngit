...
?>
  ...
  <tr>
    <td colspan="5"><span class="require-field"><?php echo $this->_var['lang']['price_note']; ?></span></td>
    <td align="right"><strong><?php echo $this->_var['lang']['label_total']; ?></strong></td>
    <td align="right"><?php echo $this->_var['goods_amount']; ?></td>
    <td><?php if ($this->_foreach['goods']['total'] > 0): ?><input name="edit_goods"  class="button" type="submit" value="<?php echo $this->_var['lang']['update_goods']; ?>" /><?php endif; ?>
...
<p>
  ...
  <input type="button" name="search" class="button" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchGoods();" />
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    <td colspan="2" align="center"><input name="add_goods" type="submit"  class="button" value="<?php echo $this->_var['lang']['add_to_order']; ?>" /></td>
  </tr>
</table>
</div>
</form>
