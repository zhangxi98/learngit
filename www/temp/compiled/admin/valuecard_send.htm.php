...
<div class="main-div">
<form action="valuecard.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
<table width="100%">
...
<input type="hidden" name="vc_type_id" value="<?php echo $this->_var['vc_type_id']; ?>" />
